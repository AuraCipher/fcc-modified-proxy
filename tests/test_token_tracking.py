...
def test_token_tracking() -> None:
    ...
    tracker.add_tokens(
        "nvidia_nim", "deepseek-ai/deepseek-v4-pro", input_tokens=100, output_tokens=320
    )
    ...
    tracker.add_tokens(
        "openrouter", "openai/gpt-4.5-turbo", input_tokens=180, output_tokens=290
    )
    tracker.add_tokens(
        "openrouter", "openai/gpt-4", input_tokens=160, output_tokens=210
    )
    ...
    tracker.add_tokens(
        "deepseek", "deepseek-v4-pro", input_tokens=140, output_tokens=340
    )
