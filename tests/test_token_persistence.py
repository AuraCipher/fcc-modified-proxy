...
def test_token_persistence():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch("core.token_tracking._get_db_path", mock_get_db_path):
            ...
            tracker1.add_tokens("nvidia_nim", "z-ai/glm4.7", input_tokens=150, output_tokens=250)
            tracker1.add_tokens("nvidia_nim", "deepseek-v4-pro", input_tokens=200, output_tokens=300)
            tracker1.add_tokens("openrouter", "gpt-4-turbo", input_tokens=100, output_tokens=150)
            ...
            print(f"  - Models found: {sum(len(m['by_model']) for m in report2['by_provider'].values())}")
            ...
            tracker2.add_tokens("nvidia_nim", "z-ai/glm4.7", input_tokens=100, output_tokens=200)
            ...
            assert report3['total']['input_tokens'] == 550, "Input tokens after accumulation mismatch"
            assert report3['total']['output_tokens'] == 900, "Output tokens after accumulation mismatch"
            assert report3['total']['request_count'] == 4, "Request count after accumulation mismatch"
